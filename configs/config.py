...
# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224', type=str, help="vision model to use")
...
# ========================== Gumble Softmax =============================
parser.add_argument('--gumble_threshold', default=0.2, type=float, help='gumble softmax threshold for selecting disease-wise patches')
parser.add_argument('--gumble_tau', default=0.3, type=float, help='gumble softmax parameter')
